...
3. Use strftime() for date formatting: strftime('%Y-%m', CAST(sale_date AS DATE))
4. Use proper JOINs when combining tables
5. Include appropriate GROUP BY, ORDER BY, and LIMIT clauses
6. For revenue/sales analysis, use SUM(total_amount)
7. For customer analysis, join sales with customers table
8. For product analysis, join sales with products table
